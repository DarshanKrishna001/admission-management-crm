...
// ═══════════════════════════════════════════════════════════════════════════════
// PORTAL API  — /api/portal/**  — PUBLIC, no JWT needed
// Used by the student self-registration page (/apply)
// ═══════════════════════════════════════════════════════════════════════════════
...
// Shared error normaliser for public requests
...
export const portalApi = {
  /** Submit a new application — students call this themselves */
  apply:       (data) => publicAxios.post('/apply', data),

  /** Check application status by Application ID */
  checkStatus: (id)   => publicAxios.get(`/status/${id}`),

  /** Get programs list for the application form dropdown */
  getPrograms: ()     => publicAxios.get('/programs'),
}
