      ...
      <Box sx={{
        ...
        <Card sx={{
          ...
          <Typography sx={{ color: 'rgba(255,255,255,0.5)', mb: 3, lineHeight: 1.8 }}>
            Your account{' '}
            <Box component="span" sx={{ color: selectedRole?.color || '#38bdf8', fontWeight: 700, fontFamily: 'monospace' }}>
              {registeredUsername}
            </Box>{' '}
          ...
          <Box sx={{
            ...
            <Typography sx={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, mb: 0.5 }}>
              Username:{' '}
              <Box component="span" sx={{ color: 'white', fontWeight: 600, fontFamily: 'monospace' }}>
                {registeredUsername}
              </Box>
            </Typography>
            <Typography sx={{ color: 'rgba(255,255,255,0.6)', fontSize: 13 }}>
              Role:{' '}
              <Box component="span" sx={{ color: selectedRole?.color, fontWeight: 600 }}>
                {selectedRole?.label}
              </Box>
            </Typography>
          </Box>
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, width: '100%', maxWidth: 340 }}>
          {ROLES.map(r => (
            <Box key={r.value} onClick={() => setForm(f => ({ ...f, role: r.value }))} sx={{
